...
public class GroupsAddAndDeleteGroupTest extends TestBase {
	...
	driver.findElement(By.id("edit-group-name")).sendKeys("√1");//заполн€ем пол€ данных
	...
	driver.findElement(By.xpath("//div[@id='bgroup_1']/div/table/tbody/tr/td[8]/div/a/span")).click(); //удал€ем группу
