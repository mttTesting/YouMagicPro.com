...
public class PasswordNoMatchTest  extends TestBase{
	...
	public void PasswordNoMatchTest_C27054() {
		...
		driver.findElement(By.id("edit-old-password")).sendKeys("1234"); //ввод неверного старого пароля
		...
		assertEquals(driver.findElement(By.cssSelector("div.messages.error")).getText(), "Введённые пароли не совпадают.");//проверяем, вывелось ли предупреждение	
	}
