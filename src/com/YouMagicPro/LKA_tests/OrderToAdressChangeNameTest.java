...
public class OrderToAdressChangeNameTest  extends TestBase{
	@Test
	public void orderToAdressChangeNameTest_C25672() {
		...
		driver.findElement(By.id("edit-first-name")).sendKeys("Иван");//меняем имя
	}
}
